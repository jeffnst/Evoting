      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Silahkan Scan ID Card Anda</h3>
          </div>
          <div class="box-body">
            <form method="post" action="<?php echo base_url() ;?>app/scan_barcode">
          <input class="form-control input-lg" name="barcode" id="barcode" type="number" autofocus required placeholder="scan id card siswa"/>
        </form>
          </div>
          <!-- /.box-body -->
        </div>
