        ...
        <h1 style="font-size:20pt">Daftar Kandidat Pemilihan Ketua OSIS SMA YPSA 2016-2017</h1>
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('admin/kandidat_list')?>",
                "type": "POST"
            },
    ...
    function edit_person(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('admin/kandidat_edit')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                if(data.foto)
                {
                    ...
                    $('#photo-preview div').html('<img src="'+base_url+'uploads/'+data.foto+'" class="img-responsive" style="width:200px;height:300px">'); // show photo
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo site_url('admin/kandidat_add')?>";
        } else {
            url = "<?php echo site_url('admin/kandidat_update')?>";
        }
    ...
    function delete_person(id)
    {
        if(confirm('Are you sure delete this data?'))
        {
            ...
            $.ajax({
                url : "<?php echo site_url('admin/kandidat_delete')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="no_urut" placeholder="No Urut Kandidat" class="form-control" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="posisi" placeholder="Posisi" class="form-control " type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
